...
verify-staking:
	source .env && forge verify-contract --chain 19850818  --compiler-version v0.8.26 --verifier blockscout --verifier-url $TEST_NET_VERIFIER_URL 0xb5aC5fDC2357892E019D1851a49251d8977744f7 src/NFTStaking.sol:NFTStaking
