...
verify-staking:
	source .env && forge verify-contract --chain 19850818  --compiler-version v0.8.26 --verifier blockscout --verifier-url $TEST_NET_VERIFIER_URL 0x08752737e6e8F2f00552758919B21C2bA0A8671a  src/NFTStaking.sol:NFTStaking
